...
according to biomass. Especially BEF predicts a positive link between species
richness and community biomass especially in grassland.
...
1. Option1 Global change -> change of biomass 
   Option2 Ecological communities are dynamics + example
 
2. Ecological communities often describe by their richness, biomass
...
- The low effect of community size suggests that the architecture of the
  community in terms of species richness, number of piscivorous species, plays a
  role in its dynamics

## Interpretation

- Richness:
  - When biomass increases, species richness increases as well
...
- Avg trophic level: 
  ...
  - Low and gain of biomass are linked to big individuals
