...
save_plot(
  "figures/decreasing_biomass_network.png", g,
  nrow = 3,
  ncol = 4,
  base_height = 4,
  base_width = 4)
...
save_plot(
  "figures/increasing_biomass_network.png", g2,
  nrow = 4,
  ncol = 4,
  base_height = 4,
  base_width = 4)
...
save_plot(
  "figures/decreasing_biomass.png", tps_bm_dec,
  nrow = 1,
  ncol = 1,
  base_height = 4,
  base_width = 7)
...
save_plot(
  "figures/increasing_biomass.png", tps_bm_inc,
  nrow = 1,
  ncol = 1,
  base_height = 4,
  base_width = 7)
...
plot_temporal_variable_lm <- function(
  ...
  .df %>%
    ...
    mutate(
      ...
      station = str_replace_all(station, setNames(names(st), st))
      ) %>%
