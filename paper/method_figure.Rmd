...
save_plot(
  get_mypath("figures/decreasing_biomass_network.png"),
  g,
  nrow = 3,
  ncol = 4,
  base_height = 4,
...
save_plot(
  get_mypath("figures/decreasing_biomass.png"), tps_bm_dec,
  nrow = 1,
  ncol = 1,
  base_height = 4,
  base_width = 7)
...
save_plot(
  get_mypath("figures/increasing_biomass.png"), tps_bm_inc,
  nrow = 1,
  ncol = 1,
  base_height = 4,
  base_width = 7)
...
plot_temporal_variable_lm <- function(
  ...
  tex <- .df %>%
    ...
    tex %>%
      ...
      geom_point() +
      geom_smooth(aes(group = station), method = "lm", formula = y ~ x,
        size = 1, se = FALSE, color = "black") +
...
save_plot(
  get_mypath("figures/p_dec_log_bm.png"),
  p_dec_log_bm,
  nrow = 1,
  ncol = 1,
  base_asp = 1.618,
...
```{r}
tps_dec_inc <- map(c("ct_ff", "w_trph_lvl_avg", "log_rich_std", "piel_bm"),
  ~plot_temporal_variable_lm(st = st_decreasing, var = .x)
)
save_plot(
  filename = get_mypath("figures/net_str_dec_bm.png"),
  plot_grid(plotlist = tps_dec_inc),
  nrow = 2, ncol = 2,
  base_asp = 1.618,
  base_width = 5
...
p <- get_network_temporal_plot(
  ...
  selected_years = c(1996, 2006, 2016),
  node_color = my_species_color, scale_node_size = 0.027,
  par_options = par(mar = c(0,0,0,0)),
  log_abun = TRUE
)
