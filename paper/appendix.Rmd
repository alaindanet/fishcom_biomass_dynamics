...
# Comparison of analysis in space and time
...
# Disantengling functional and redundant links
...
```{r}
rand_sim_cap <- paste0(
  "Simulations of (b) nodes extinctions in the metaweb according to three
  ...
  linear model for the 50 random extinction sequences."
)
```
