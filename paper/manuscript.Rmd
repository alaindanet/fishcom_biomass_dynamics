...
# Abstract (242 / 250 words max)

Understanding how biodiversity changes is a central question in ecology, but a
challenging one because of the multidimensionality of biodiversity changes.
...
a space-for-time equivalence, which have rarely tested. We questioned the
relationships between the temporal changes of food-web structure and the ones of
community biomass and species richness, and assessed if they differed from the
ones estimated in space. We inferred the structure of using food diet and body
size data from fish monitoring in France. We estimated the temporal trends of
food-web structure in 400 sites using a hierarchical Bayesian model and then
assessed the relationships among them using structural equation models. We found
that temporal trends of connectance and average trophic level are positively
related to ones of community biomass but surprisingly poorly related to the
temporal trends of species richness, which resonates with the energetic paradigm
of food-webs. We further found general support for the space-for-time hypothesis
for community biomass, but not for species richness. Our study
sheds a new light on the dynamics of food-web assemblage in natural settings and
how the structure of ecological networks changes according to the changes of
...
Using a Bayesian hierarchical model to estimate conjointly the temporal trends of
food-web structure at all sites, we found weak evidence of a global decrease in
community biomass (CI80%:`r gbm` by decade; median [Credible Interval], Fig. S1) but of a
...
relationships among food-web structure descriptors, we found a strong positive
...
$r_\delta$: standardized slope coefficient, [95% CI]), meaning that both
...
Our results suggest that the disturbances that lead to decline or increase of
community biomass over time are concomitant to the decline and increase
respectively of trophic species at high trophic level. We found that both
connectance and average trophic level had a positive relationship with community
biomass over time, meaning that connectance and average trophic level increase
over time when community biomass increases over time as well, and likewise that
connectance and average trophic level decrease over time when community biomass
decreases over time. We also found that the temporal trends of connectance and
average trophic level were strongly correlated (Fig. S3). Likewise, we found
that the temporal trends of community biomass were positively associated to the
temporal trends of both number and proportion of piscivorous species
present (Fig. S3). This result is in accordance with the
energetic paradigm of food-webs which proposes that food-webs are primarily
constrained by fluxes of matter and energy [@lindeman_trophic-dynamic_1942],
which suggest that productivity constraints food chain length by energy
limitation [@jenkins_productivity_1992; @takimoto_ecosystem_2008]. Higher
trophic levels have been shown to be more sensible to ecosystem size
[@takimoto_ecosystem_2008; @post_ecosystem_2000], to resource availability and
disturbance in small systems [@post_long_2002] and particularly to disturbance
in hydrologic regimes in streams [@sabo_role_2010; @mchugh_dual_2010;
@jake_vander_zanden_global_2007]. In the same line, the metabolic theory of
ecology also predicts that top predators are highly constrained by energy
limitation [@arim_relationship_2007]. However, this interpretation holds if
the temporal trends of community biomass are related to the quantity of resource
available. Another explanation can be that top trophic level species are often
the ones that are targeted, harvested and those that are artificially introduced
for recreational fisheries [@reid_emerging_2019]. Further investigations on the
drivers of community biomass decline and increase over time would be needed to
further conclude.
...
trends of species richness (Fig. S3), meaning that communities that increase in
richness over time have an increase in the proportion of non-piscivorous species over time
...
Our findings further suggest that species richness and community biomass have
antagonistic effects on connectance, respectively negative and positive. As we
found a strong positive relationship between the temporal trends of species
richness and community biomass, it results that species richness temporal trends
had an indirect positive effect on the temporal trends of both connectance and
average trophic level via community biomass. Then,  The temporal trends of
...
related to species of higher trophic level in our system has a strong reasoning
with the effect of human fisheries in marine systems which affect primarily fish
species at top trophic levels [@sprules_surfing_2016].

We found evidence that space-for-time substitution is valid for community
biomass but not for species richness. More specifically, we found a positive
relationship between community biomass and species richness both in space and
time. We also found that connectance was positively linked to community biomass
both over space and time, it resonates with theoretical studies showing that
higher food-web connectance can result in higher community biomass
[@thebault_food-web_2003], or lower [@poisot_trophic_2013] over space,
highlighting that the relation between connectance and community biomass may be
dependent on how food-web structure change with community biomass over space and
time. Likewise, we found that the average trophic level had a positive
relationship with community biomass over space and time, in accordance with a
theoretical study predicting an increase of community biomass
linked to the presence of higher predators [@wang_biodiversity_2018].
However, while we found a total negative effect between connectance and species
richness in space, in accordance with previous findings over space in
empirical food-webs [@dunne_network_2006; @danet_species_2021], we found a null
total effect in time. The result is even more contrasting for average trophic
level, where we found a total positive effect of species richness in time but a
negative one in space. This result is also in line with other studies which
found a mismatch between spatial and temporal patterns [@adler_contrasting_2007;
@johnson_testing_2008]. This discrepancy in space and time might be due to the
strong assumption that variations in space reflect differences in assembly
stages of ecological communities and then mirror their temporal
assembly/disassembly trajectories. Temporal variation of species richness might
relate to transitory dynamics while spatial gradients reflect aggregated
dynamics over a longer time scale including a far number of processes including
high species turnover along spatial gradients. Our results then suggest that food-web
structure comparison along space gradient might be a reasonable surrogate for
time sequence, it is probably not the case for species richness spatial
comparison.
...
changes in time are related to variations of food-web structure at the
higher trophic levels while changes in species richness are weakly related to
changes in food-web structure, in accordance with the energetic
paradigm of food-webs. Our results further highlight that the effects of species
richness changes on food-web structure are strongly mediated by antagonistic
effects of community biomass. We also find evidences which suggest that
space-for-time substitution may be relevant to predict the effects of community
biomass losses or gains on food-web structure but also that space-for-time
substitution might not work for species richness. Our study calls for further
investigations to support the generality of assembly rules in food-webs,
according to changes in community biomass and species richness. They are crucial
to better understand how biodiversity changes will affect community dynamics
