...
Our result suggest that food-webs that experienced a decline in community
...
such communities to further perturbations. Our study highlight how biodiversity
...
@danet_past_2024]. It is increasing recognised that biodiversity changes alter
community structure [@dornelas_assemblage_2014; @hillebrand_biodiversity_2018;
@danet_past_2024], but so far, one key component of biodiversity, species
interactions, has been mostly ignored by studies assessing temporal changes in
biodiversity, despite the importance of biotic interactions for species
coexistence, ecosystem functioning and stability [@chesson_mechanisms_2000;
@thebault_food-web_2003; @oconnor_general_2017; @danet_species_2021]. A better
understanding of biodiversity changes will then need to account how biodiversity
changes alter the structure of ecological networks.
...
and redundancy (i.e. the proportion of redundant links). Their are pieces of
...
[@lajaaiti_ecologicalnetworksdynamicsjl_2024].
