...
from `r grbmn`% to +`r grbmx`% per decade, species richness: `r grrhn` to
...
effectively captured by the hierarchical model ( conditional R2 ranging from
`r r2cond$log_bm_std` for community biomass to `r r2cond$log_rich_std` for
species richness, Table S2).
