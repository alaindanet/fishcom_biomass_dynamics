...
[@thebault_food-web_2003; @oconnor_general_2016]. In food-webs, spatial
...
etc...), . Over the `r nb_st` monitored sites, the selection procedure resulted in `r
nb_st_rich_bm` sites for community biomass and species richness analysis. However, the
...
biomass. Spatially, this result is in accordance 
with previous studies in stream communities [@woods_testing_2020; @danet_species_nodate] but also
...
@grace_integrative_2016]. Therefore, our results confirm that
Biodiversity-Ecosystem functioning prediction
works also in the temporal dynamics of food-webs. The positive relationship between species
...
## The temporal of community biomass and species richness relates on different assembly and disassembly rules
...
community biomass and species richness are associated with very different temporal trends on the
connectance, average trophic level and evenness of biomass. Indeed, temporal trends of connectance and average
trophic level were positively associated to the temporal trends of community biomass while no
significant association was found with temporal trends of species richness.
Moreover, the temporal trends of biomass evenness were negatively associated to the temporal
trends of community biomass whereas positively associated to temporal trends of
species richness. All together, it suggests that temporal trends of community
biomass and species richness are related to different assembly and disassembly
processes in food-webs. 

The temporal trends of connectance were positively linked to that of community
biomass, meaning that when connectance increased through time in a given site
when community biomass increased through time. Reversely, connectance decreased
...
bodied predators. This interpretation is in line with the results that community
biomass losses through time were associated to a temporal decrease of average
trophic level and that community biomass temporal gains were associated to
temporal increase of average trophic level. Another piece of evidence is that
evenness of biomass, measured by the Pielou index, decreased through time as
community biomass increased, meaning that biomass distribution across species
becomes less even when community biomass increased. Reversely, in food-webs that
displayed temporal decrease in community biomass, we found that evenness of
biomass increased, i.e. that biomass distribution across species becomes more
even.  Because predator-prey interactions relate in part on bodysize and thus
bodymass to a certain extent, we may expect that a given gain in predators of
higher trophic level leads to a decrease of biomass evenness and reversely. In
the same line, we found that the temporal trends of community biomass were positively
correlated to the temporal trends of the number and proportion of piscivorous
trophic species present in fish communities (Fig. SXX).

In contrast, we found that temporal trends of connectance and average trophic level
were not related to the temporal trends of species richness. However, we found
...
richness observed in our data are concomimant to losses of
piscivorous and non-piscivorous species, leading to the absence of temporal
trends in connectance and average trophic level and symmetrically for the
...
richness, in contraction of what we found for temporal trends of community biomass.
...
positive and negative  temporal trends of species richness are linked to gains and
losses of redundancy in food-webs, without overall effects on connectance
