...
to +`r grrhx`%, average trophic level: `r grtln` to +`r grtlx`, connectance: `r
grctn` to +`r grctx`, redundancy: `r grln` to +`r grlx`, Fig. S1) which was well
captured by the hierarchical model with conditional R2 going from `r r2cond$log_bm_std` for community biomass to `r r2cond$log_rich_std` for species
richness (Table S1).
...
and `r rdm$ct$bm`, Fig. \@ref(fig:std)), average trophic level (resp.
...
$r_\delta =$ `r rdtps$red$r`, `r ridtps$red$r`), which adds up to a strong
...
food-webs that have experienced a decrease in species richness over time have
decreased in average trophic level and redundancy but increase in connectance,
and conversely, those that increased in species richness have increased in
average trophic level, redundancy, but decreased in connectance.

The effects of spatial variations in species richness on food-web structure
mostly agreed with the ones found with temporal trends. We found a direct negative
...
and `r rdm$red$r`). Species richess had indirect positive effect of species
...
- Revise: biomass pyramids, connectance different from top predators
- Add redundancy
...
biomass translates in food-webs with *lower connectance* and fewer top predators
while increases in biomass results in food-webs with higher connectance and more
top predators. In turn, decline in species richness translates in food-webs with
fewer trophic links and top predators while
increases in biomass results in food-webs with more trophic links and top
predatorstranslate in low changes in
food-web structure, suggesting that species richness changes relates more to
trophic role
...
community biomass but not so well for species richness.
