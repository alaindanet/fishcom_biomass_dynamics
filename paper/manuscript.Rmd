...
- Biodiversity changes = changes in food-web structure that are important for
  ecosystem functioning and stability.
- Unique combination of empirical data and theoretical simulations.
- Inform how community biomass and species richness declines result in an
  increase of the fragility of food-webs.
...
- Ideas:
  1. Biodiversity at risk; widespread heterogeneity in changes; ignores
     community struture
  2. Community structure is important for ecosystem functioning and robustness
     to perturbations
  3. Questions: assembly and disassembly processes of food-webs associated with
     biodiversity changes?; possible due to inference of food-web structure;
     Energetic constraints, redundancy and robustness; Validity of space for
     time hypothesis
  4. Presentation of the study data, theoretical models and extinction
     simulation: presentation of the hypothesis associated to the SEM

Why redundancy? Because not all links in the same way to the robustness of
food-webs
...
found that the presence of higher trophic levels is associated to a higher
temporal stability of community biomass in theoretical models and empirical data
...
std_cap <- paste0(
  ...
  95\\%. Values are displayed in Table SXX, R-squared in Table SXX, and the
  visualisation of the bivariate relationships for the spatial and bioenergetic
  model SEMs are displayed in Figure SXX.")
