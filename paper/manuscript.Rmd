...
factor < 3, Table XX).  We visually inspected the residuals of the linear models
(TODO).
...
in biomass
over time loose generalist predators over time, as connectance measures the degree of generalism and reversely that communities
...
```{r bmr, out.width="80%", fig.height=7, fig.cap=fig_bm_rich_cap}
plot_grid(
