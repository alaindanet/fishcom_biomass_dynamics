...
std_cap <- paste0( "a, Direct and total effects of community biomass and species
  ...
  intervals at 95\\%. Values are displayed in Table S4, R-squared in Table S5, and
  the visualization of the bivariate relationships for the spatial and
  bioenergetic model SEMs are displayed in Fig. S4. Average trophic level is
...
`r nb_st` sites (Fig. \@ref(fig:matmet)a, Table S2).
...
with the Nagelkerke method [@lefcheck_piecewisesem_2016, Table S5].
