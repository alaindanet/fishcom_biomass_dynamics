...
current biodiversity is at risk, numerous
studies reported dramatic declines of population and community biomass
[@ceballos_biological_2017; @hallmann_more_2017; @albano_native_2021], as well
as ongoing extinction [@barnosky_has_2011]. Consequences of such trends on various
...
The temporal trends of species richness and community biomass are likely to
affect community structure. The positive link between Biodiversity and ecosystem
functioning shown in experimental studies predict that loss and gain of species
richness should respectively result in loss and gain of community biomass
...
@li_relationship_2018; @maureaud_biodiversityecosystem_2019]. Numerous
studies find relation between species richness and evenness, but their disagree
on the sign of the relationships [@soininen_relationship_2012; @ma_species_2005;
...
network, has been theoretically shown to theoretically positively scale with
...
community and network structure. The hypothesis that space can
...
succession of vegetation from space variations [@pickett_space-for-time_1989]. It
...
[@damgaard_critique_2019], with studies showing analogous patterns in space and time
...
stochastic processes have been hypothesised to be responsible for the failure of
space for time substitution [@adler_contrasting_2007; @blois_space_2013].

In this line, how community biomass and species richness temporal trends are linked to
change in food-web structure is still an open question, as well as if space for
time substitution works to infer consequences of species richness and community
biomass on food-web structure. The increasing availability of ecological
temporal series makes possible to assess those questions.
