...
# Abstract (267 / 250 words max)

Understanding how biodiversity changes is a central question in ecology, but
still challenging because of the multidimensionality of biodiversity changes.
Although the structure of ecological networks is a crucial determinant of
community dynamics, this dimension of biodiversity changes have been greatly
overlooked. One main reason is the scarce availability of the temporal series of
ecological networks. Our knowledge of the relationships among structural
properties of ecological networks comes mainly from spatial comparison, assuming
a space-for-time equivalence. However, little is know about the validity of the
space-for-time hypothesis, i.e. if spatial comparison of ecological networks
accurately translates temporal sequences of assemblages. Here we questioned the
relationships between the temporal trends of food-web structure and the ones
of community biomass and species richness, and we assessed how those
relationships differed from the ones estimated in space. We inferred the
structure of using food diet and individual body size data from fish monitoring
in France. We estimated the temporal trends of food-web structure in 400 sites
using a hierarchical Bayesian model and then assess the relationships among them
using structural equation models. We found that temporal trends of connectance
and average trophic level are positively related to ones of community biomass
but surprisingly poorly related to the temporal trends of species richness. We
further found support for space-for-time hypothesis for community biomass, but
not for species richness. We suggest that our results resonates with the
energetic paradigm of food-webs. Our study sheds a new light on the dynamics of
food-web assemblage in natural settings and how the structure of ecological
networks changes according to the changes of other biodiversity facets. 

# Significance (109 / 120 words max)

While the multidimensional nature of biodiversity changes has been clearly
emphasized, little is know how the structure of food-web changes according to
...
structure in time according to simultaneously changes in species richness and
community biomass. We identify that community biomass is the primary driver of
temporal changes in foodweb structure, but that species richness has surprisingly
low effect. We further show that space-for-time leads to contrasting results for
species richness. Our results shed a new light on how foodweb assemble
and disassemble in natural settings.

# Introduction (487 words)

There is rising recognition that biodiversity changes are
multidimensional [@mcgill_fifteen_2015; @blowes_geography_2019;
@hillebrand_biodiversity_2018; @blowes_local_nodate]. Studies found important
changes in species composition despite no changes in species richness in average
[@dornelas_assemblage_2014; @blowes_geography_2019], and highlighting the need
for further investigations on how biodiversity changes over time.

Yet species interactions are largely absent from biodiversity changes. Although
species interactions, described as ecological networks, drive for a large part
community composition, species coexistence, and ecosystem
...
Th availability of ecological network timeseries is
scarce [@kortsch_disentangling_2021], such as predictions about how the structure
...
negatively related to species richness in small (i.e. below 20 species)
empirical food-webs [reviewed in @dunne_network_2006], which reflects
constraints on the number of realizable species interactions or an increasing
proportion of specialists in more rich foodwebs. Connectance has been shown to
scale positively or negatively with community biomass in theoretical
food-webs [@thebault_food-web_2003; @poisot_trophic_2013] while the average
trophic level was previously shown to scale negatively with species
richness [@danet_species_2021].
...
foodweb structure at all sites, we found weak evidence of a global decrease in
...
biomass to `r r2ic$log_rich_std` for species richness (Table S1).
...
($r_\delta =$ `r rttps$ct$r`), that we also found in random extinction
simulation (Fig. S2).
...
\@ref(fig:sem)e), meaning that sites where community biomass decreased over
time, average trophic level decreased over time and reversely. It means that in
communities losing biomass over time, the average biomass of the food-web moved
down to lower trophic level and vice versa. However, we found that the temporal
trends of average trophic level had no direct relationship the ones of species
richness ($r_\delta =$ `r rdtps$tlvl$r`, Fig. \@ref(fig:sem)f). It suggests that
in communities either losing or gaining species richness over time, the location
of average biomass along trophic level does not significantly change according
to species richness. However, the temporal trends of species richness had an
indirect positive relationship with the temporal trends of average trophic level
through community biomass ($r_\delta =$ `r ridtps$tlvl$r`), resulting in a total
positive relationship ($r_\delta =$ `r rttps$tlvl$r`).
...
spatial and temporal analysis. This result is in accordance with previous
...
@li_relationship_2018; but see @grace_integrative_2016]. Therefore, our results
suggest that Biodiversity-Ecosystem functioning prediction also hold in the
temporal dynamics of food-webs. The positive relationship between species
...
probability of getting high biomass species with higher species
richness [@loreau_biodiversity_2001].

We found that both connectance and average trophic level had a positive
relationship with community biomass over time, meaning that connectance and
average trophic level increase over time when community biomass increases over
time as well, and likewise that connectance and average trophic level decrease
over time when community biomass decreases over time. We also found that the
temporal trends of connectance and average trophic level were strongly
correlated (Fig. S2). All together, it suggests that the disturbances that
lead to decline or increase of community biomass over time are concomitant to
the decline and increase respectively of trophic species at high trophic level.
Likewise, we found that the temporal trends of community biomass were positively
associated to the temporal trends of both number and proportion of piscivorous
fish species present in the communities (Fig. S2). This result is in
accordance with the energetic paradigm of food-webs which proposes that
food-webs are primarily constrained by fluxes of matter and energy
[@lindeman_trophic-dynamic_1942], which suggest that productivity constraints
food chain length by energy limitation [@jenkins_productivity_1992;
@takimoto_ecosystem_2008]. Higher trophic levels have been shown to be more
sensible to ecosystem size [@takimoto_ecosystem_2008; @post_ecosystem_2000], to
resource availability and disturbance in small systems [@post_long_2002] and
particularly to disturbance in hydrologic regimes in streams [@sabo_role_2010;
@mchugh_dual_2010; @jake_vander_zanden_global_2007]. In the same line, the
metabolic theory of ecology also predicts that top predators are highly
constrained by energy limitation [@arim_relationship_2007]. However this
interpretation does hold if the temporal trends of community biomass are related
to the quantity of resource available. Another explanation can be that top
trophic level species are often the ones that are targeted, harvested and those
that are artificially introduced for recreational fisheries
[@reid_emerging_2019]. Further investigations on the drivers of community
biomass decline and increase over time would be needed to further conclude.

In contrast, we found that the temporal trends of connectance was negatively
related to the temporal trends of species richness, in accordance with the
strong negative relationships that we found in the present study and from
previous results over spatial gradient [@dunne_network_2006;
@danet_species_2021]. Furthermore, we found that temporal trends of the
proportion of piscivorous species was negatively associated with the temporal
trends of species richness (Fig. S2), meaning that communities that increase in
richness over time have an increase in the proportion of non-piscivore over time
and vice versa. This result is in accordance with a meta-analysis showing the
number of species by trophic level decrease toward higher trophic level
[@turney_pyramids_2016]. It suggests that the temporal increase of species
richness found in our dataset is associated with a decrease of connectance
because species richness increases are biased toward non-piscivorous species
which have no piscivory links. We also found that the changes of average trophic
level over time were not related to the changes of species richness over time.
All together, an explanation can be that species richness changes over time,
without changes in community biomass, are more linked to non piscivorous species
having lower trophic level and relatively low biomass, which results in negative
relationships with temporal trends in connectance and no relationship with
average trophic level.

However, as we found a strong positive relationship between the temporal trends
of species richness and community biomass, it results that species richness
temporal trends had an indirect positive effect on the temporal trends of both
connectance and average trophic level via community biomass. Then, our study
suggests that species richness and community biomass have antagonistic effects
on connectance, respectively negative and positive. The temporal trends of
species richness had then a total effect on the temporal trends of connectance
and average trophic level which was twice lower than the one of the temporal
trends of community biomass. It suggests that the temporal assembly and
...
stabilize communities [@wang_biodiversity_2018; @shanafelt_stability_2018;
@danet_species_2021]. In contrast, the loss of species richness might be linked
to loss of redundancy in the food-web, highlighting that those communities may
become more at risk regarding future perturbations [@yachi_biodiversity_1999].
Interestingly, the hypothesis that temporal trends in community biomass is
related to higher trophic level in our system has a strong reasoning with the
effect of human fisheries in marine systems which affect primarily fish species
at top trophic levels [@sprules_surfing_2016].

Regarding the space-for-time substitution, we found that connectance was
positively linked to community biomass both over space and time. This result
resonates with theoretical work showing that higher food-web connectance can
result in higher community biomass [@thebault_food-web_2003], or lower
[@poisot_trophic_2013] over space, highlighting that the relation between
connectance and community biomass may be dependant on how food-web structure
change with community biomass over space and time. Likewise, we found that the
average trophic level had a positive relationship with community biomass over
space and time, in accordance with a theoretical study over space predicting an
increase of community biomass subsequent to the presence of higher predators
[@wang_biodiversity_2018]. Finally, we found a positive relationship between
community biomass and species richness both in space and time, however the
temporal relationship was stronger. We also found a negative relationship
between connectance and species richness space and time, in accordance with
previous findings over space in empirical food-webs [@dunne_network_2006]. We further
found no relationship between average trophic level and species richness over
time while we found a twice stronger but positive relationship between median
average trophic level and median species richness over the spatial gradient. An
explanation might be that environmental gradient and the pattern of fish
migration since the last glaciation, for the strong negative effect of species
richness on both connectance and average trophic level over spatial gradient.
However, we controlled our spatial analysis by the Biological Demand in Oxygen,
water temperature and the stream gradient. This result is also in line with
other studies which found a mismatch between spatial and temporal patterns
[@adler_contrasting_2007; @johnson_testing_2008]. This discrepancy in space
and time might be due to the strong assumption that variations in space reflect
differences in assembly stages of ecological communities and then mirror their
temporal assembly/disassembly trajectories. Temporal variation of species
richness might relate to transitory dynamics while spatial gradients reflect
aggregated dynamics over a longer time scale including a far number of processes
including high species turnover along spatial gradients.
...
or gains on food-web structure but also that space-for-time substitution might
not work for species richness. Our study calls for further investigations to
support the generality of assembly rules in food-webs. They are crucial to
better understand the assembly and disassembly of food-webs and then predict its
...
[@bonnaffe_comparison_2021; @danet_species_2021]. The ontogenic fish diet
database was filled according to fishbase (Froese et al. 2021) and literature
[@bonnaffe_comparison_2021; @danet_species_2021].
...
average Biological Oxygen Demand [BOD, @mallin_factors_2006]. We further
...
with the Nagelkerke method [@lefcheck_piecewisesem_2016].

All the statistical models displayed low multicollinearity (Variance inflation
factors < 3, Table SXX).  We visually inspected the residuals of the linear
models.
...
We simulated extinction sequences in the metaweb according to three scenarios to get expectations on how the food-web structure should change according to the addition and deletion of species and nodes. The scenario of extinction sequences were related to the trophic level of the species/nodes. In the decreasing and increasing scenario, we removed species/nodes in decreasing, resp. increasing order, of their trophic level, i.e. respectively the higest and lowest trophic level first. In the random extinction sequence, we built 50 random extinction sequences. For each simulation, we removed fish species/nodes that lost all their preys. We computed the connectance, the average and the maximum trophic level. 
