...
communities that displayed high species richness at the
beginning of their monitoring tend to display decrease in species richness through time
and reversely.
...
side, we modelled the dynamics the temporal trends of food-web
...
level (Table \@ref(tab:rsq)). The spatial models
 were more performant, with $R_{cond}^2$ varing from 
`r rsq_tlvl_sp` to `r rsq_piel_bm_sp` (Table \@ref(tab:rsq-sp)).
...
\@ref(tab:aov)), meaning that the eveness of biomass across species
...
temporally increased (Fig. \@ref(fig:bm), Table \@ref(tab:aov)). We observed the
same pattern between the temporal trends of
community biomass and that of the pielou of individual number. 
...
(Fig. \@ref(fig:rich), Table \@ref(tab:aov)). However, the direct
...
community biomass (Fig. \@ref(fig:bm), Table \@ref(tab:aov-sp)). However,
...
community biomass (Fig. \@ref(fig:rich), Table \@ref(tab:aov-sp)).
