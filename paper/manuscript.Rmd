...
p_bm <- fig1_2$bm
names(p_bm) <- c("ct_ff", "w_trph_lvl_avg")
...
temporal and spatial models. The bar tops display the standardized slope coefficients
from the models ($r_\\delta$), the lines around bar tops display the standard errors.")
```
